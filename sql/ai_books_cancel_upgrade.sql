...
-- Canceled rows remain for audit, but are excluded from the daily quota.
...
comment on column public.ai_books.status is
  'generating, ready, failed, or canceled. Canceled rows do not consume the daily creation quota.';
