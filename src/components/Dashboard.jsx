...
export default function Dashboard({ setPage }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 pt-2 pb-10">
      ...
      <button onClick={() => setPage('rewards')} className="h-36 bg-yellow-500 text-white rounded-[2rem] shadow-xl font-black flex flex-col items-center justify-center gap-1 italic tracking-tighter uppercase text-sm transform active:scale-95 transition-all">
